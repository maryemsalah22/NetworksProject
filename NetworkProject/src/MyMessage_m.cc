...
void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->ack_number);
...
void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->ack_number);
...
int MyMessage_Base::getAck_number() const
{
    return this->ack_number;
}

void MyMessage_Base::setAck_number(int ack_number)
{
    this->ack_number = ack_number;
}

int MyMessage_Base::getTrailer() const
{
    return this->trailer;
}

void MyMessage_Base::setTrailer(int trailer)
{
...
unsigned int MyMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_ack_number
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "frame_type") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "ack_number") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "trailer") == 0) return baseIndex + 4;
...
std::string MyMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ack_number: return long2string(pp->getAck_number());
...
void MyMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ack_number: pp->setAck_number(string2long(value)); break;
...
omnetpp::cValue MyMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ack_number: return pp->getAck_number();
...
void MyMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ack_number: pp->setAck_number(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_trailer: pp->setTrailer(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'MyMessage_Base'", field);
    }
}
